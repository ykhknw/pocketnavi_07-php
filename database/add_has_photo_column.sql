-- has_photoカラムをbuildings_table_2に追加
...
CREATE INDEX idx_has_photo ON buildings_table_2(has_photo);
CREATE INDEX idx_has_photo_building_id ON buildings_table_2(has_photo, building_id);
