// PlanetScale対応API通信サービス
import { Building, SearchFilters, Architect, Photo } from '../types';

const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://your-vercel-api.vercel.app';
...
export const planetScaleApiClient = new PlanetScaleApiClient();